...
These examples are meant to illustrate how this command can generate a comprehensive view of the content of an EPUB by outputting a [Readium Web Publication Manifest](https://readium.org/webpub-manifest/).

Outputs are based on publications available from the [EPUB 3 Samples project](https://idpf.github.io/epub3-samples/30/samples.html).
  ...
  },
  {
    ...
    "properties": {
      ...
      "hash": [
        {
          "algorithm": "sha256",
          "value": "8vGN3/kAP9BlkMbpSopoSLSMZWZWDW3d2G3ZRFubgdU="
        }
      ]
    },
    "rel": "cover",
...
```json
{
  ...
  "http://purl.org/dc/terms/rights": "Copyright © 2012 O’Reilly Media, Inc",
  "http://www.idpf.org/2007/opf#version": "3.0",
  "https://github.com/readium/go-toolkit/releases": "v0.10.1",
  "https://readium.org/webpub-manifest#inferredAccessibility": {
    "feature": [
